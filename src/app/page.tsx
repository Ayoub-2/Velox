...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-24 bg-gradient-to-b from-slate-900 to-slate-800 text-white overflow-hidden relative">
      {/* Background Effects */}
      ...
      <div className="z-10 max-w-5xl w-full flex flex-col items-center text-center">
        <div className="mb-8 relative">
          ...
          <h1 className="relative text-7xl sm:text-8xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-emerald-400">
            Velox
          </h1>
        </div>
        <p className="max-w-2xl text-xl sm:text-2xl text-slate-300 mb-12 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl px-4">
          ...
          <Link
            href="/knowledge-base"
            className="group relative rounded-2xl border border-slate-700 bg-slate-800/50 p-8 hover:bg-slate-800/80 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/20"
          >
            ...
            <h2 className="mb-4 text-2xl font-bold text-white group-hover:text-blue-300 transition-colors">
          ...
          <div className="group relative rounded-2xl border border-slate-800 bg-slate-900/30 p-8 opacity-60 cursor-not-allowed">
            <h2 className="mb-4 text-2xl font-bold text-slate-500">
