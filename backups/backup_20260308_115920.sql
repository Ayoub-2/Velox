...
\restrict MydeRnM0CKbeKKdTWA28xub8sJDLa0tYB3IF8puRB44WAeqXXOKkJdk6wosqVak
...
ac3373a0-3205-4841-af6a-959c7de19dc6	39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	nuclei	Weak Content Security Policy - Detect	Detected misconfigured CSP directives containing unsafe and overly permissive keywords that weakened resource loading restrictions. This configuration allowed high-risk script behaviors, resulting in reduced protection against XSS attacks.\n	info	http://web:3000/	f
b0cf1ccb-6544-432a-9299-e83e77ccdb9e	39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	nuclei	XSS-Protection Header - Cross-Site Scripting	Setting the XSS-Protection header is deprecated. Setting the header to anything other than `0` can actually introduce an XSS vulnerability.	info	http://web:3000/	f
9f580d99-e105-4e3b-9991-8f0fd300352c	39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	nuclei	HTTP Missing Security Headers	This template searches for missing HTTP security headers. The impact of these missing headers can vary.\n	info	http://web:3000/	f
24899153-2426-4243-91d2-7b28f7ab5ef3	39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	nuclei	HTTP Missing Security Headers	This template searches for missing HTTP security headers. The impact of these missing headers can vary.\n	info	http://web:3000/	f
a22f992e-70a3-4679-96fb-348030da56f1	39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	nuclei	HTTP Missing Security Headers	This template searches for missing HTTP security headers. The impact of these missing headers can vary.\n	info	http://web:3000/	f
a20cc929-6290-47b1-89d6-f0e758c5f18e	39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	nuclei	HTTP Missing Security Headers	This template searches for missing HTTP security headers. The impact of these missing headers can vary.\n	info	http://web:3000/	f
f8d2ddd7-4c64-4b69-9a47-dcd8139d7e50	39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	nuclei	HTTP Missing Security Headers	This template searches for missing HTTP security headers. The impact of these missing headers can vary.\n	info	http://web:3000/	f
6b0b3a7f-9ea4-48a8-845e-651770b4af76	39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	nuclei	HTTP Missing Security Headers	This template searches for missing HTTP security headers. The impact of these missing headers can vary.\n	info	http://web:3000/	f
\.
...
39c750cf-5da0-4aa4-9e4e-ce43ed79fa5b	18244e11-4e3a-4221-a89e-d21ea3bc2206	luejkwl3yzml5ojncn	nuclei	completed	{"rate_limit": 50, "concurrency": 25, "auth_headers": null, "use_ajax_spider": false, "include_active_scan": false, "nuclei_tags": "cve,misconfig,exposures"}	2026-03-06 22:07:56.316037+00	2026-03-06 22:14:55.430777+00	8	0	0
...
\unrestrict MydeRnM0CKbeKKdTWA28xub8sJDLa0tYB3IF8puRB44WAeqXXOKkJdk6wosqVak
